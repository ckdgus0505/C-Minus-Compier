...
{
       0,    72,    72,    72,    93,    94,    98,    99,   103,   115,
     131,   135,   142,   149,   157,   169,   156,   184,   185,   189,
     193,   200,   214,   231,   232,   236,   237,   241,   242,   243,
     244,   245,   246,   247,   248,   252,   256,   257,   261,   271,
     281,   285,   286,   290,   291,   292,   293,   294,   295,   299,
     300,   304,   305,   309,   310,   314,   315,   319,   320,   328,
     336,   337,   338,   342,   346,   350,   351,   352,   357,   356,
     381,   382,   386,   387,   391,   392,   396,   397,   401,   404
};
#endif
...
#line 104 "parser.y" /* yacc.c:1646  */
    ...
    else if (find_symbol( current_table, (yyvsp[-1].lval).lex))
...
#line 116 "parser.y" /* yacc.c:1646  */
    ...
    else if (find_symbol (current_table, (yyvsp[-4].lval).lex))
...
#line 136 "parser.y" /* yacc.c:1646  */
    {
    (yyval.tval).type = VOID_TYPE;  // 내가 임의로 넣음
  }
...
#line 157 "parser.y" /* yacc.c:1646  */
    ...
    if(find_symbol (global_table, (yyvsp[0].lval).lex))
    {
...
#line 201 "parser.y" /* yacc.c:1646  */
    ...
    {
      if(find_symbol (local_table, (yyvsp[0].lval).lex))
...
#line 215 "parser.y" /* yacc.c:1646  */
    ...
    {
      if(find_symbol (local_table, (yyvsp[-2].lval).lex))
        error("error 14: redefined arry argument \"%s\"",(yyvsp[-2].lval).lex); 
      else
      {
...
#line 369 "parser.y" /* yacc.c:1646  */
    {
    if(!lookup_symbol((yyvsp[-4].lval).lex) == NULL)
    {
      struct symbol *symbolp;
